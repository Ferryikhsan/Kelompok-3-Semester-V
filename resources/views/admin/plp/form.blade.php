...
<div class="form-group {{ $errors->has('nama_plp') ? 'has-error' : ''}}">
    {!! Form::label('nama_plp', 'Nama Plp', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('nama_plp', null, ['class' => 'form-control']) !!}
        {!! $errors->first('nama_plp', '<p class="help-block">:message</p>') !!}
    </div>
</div>
